...
case object Empty extends TweetSet {
  ...
  def mostRetweeted: Tweet = throw new NoSuchElementException("This set has no tweets...")
...
case class NonEmpty(elem: Tweet, left: TweetSet, right: TweetSet) extends TweetSet {
  ...
  def mostRetweeted: Tweet = this match {
      case NonEmpty(e, Empty, Empty) => e
      case NonEmpty(e, l, Empty) => if (e.retweets > l.mostRetweeted.retweets) e else l.mostRetweeted
      case NonEmpty(e, Empty, r) => if (e.retweets > r.mostRetweeted.retweets) e else r.mostRetweeted
      case NonEmpty(e, l, r) => {
        if ((elem.retweets > l.mostRetweeted.retweets) && (elem.retweets > r.mostRetweeted.retweets)) elem
        else if (l.mostRetweeted.retweets > r.mostRetweeted.retweets) l.mostRetweeted
